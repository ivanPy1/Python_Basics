...
with open('lesson-5-hw-7_text.txt') as f:
    for line in f:
        firms_list = line.split(" ")
        current_profit = int(firms_list[2].strip()) - int(firms_list[3].strip())
    ...
    avg_profit_dict = {'average profit': round(total_profit/firms_num if firms_num > 0 else 0, 0)}
